...
// Flow monitor
  ...
  Simulator::Run ();
  flowMonitor->SerializeToXmlFile("400secflowmonitor.xml", true, true);
  Simulator::Destroy ();
}
...
VanetRoutingExperiment::CommandSetup (int argc, char **argv)
{
  ...
  // User is allowed to have up to 10 different PDRs (Pack30et
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
  ...
  else if (m_scenario == 2)
    {
      ...
      m_traceFile = "/home/rida/ns2mobility.tcl";
      m_logFile = "400secmob.log";
      m_mobility = 1;
      m_nNodes = 529;
      m_TotalSimTime = 400.00;
      m_nodeSpeed = 14;
      m_nodePause = 0;
      m_CSVfileName = "400sec.csv";
      m_CSVfileName = "400sec2.csv";
      m_lossModel = 1; 
      m_nSinks = 1;
      m_protocol = 2;
      m_txp = 20;
